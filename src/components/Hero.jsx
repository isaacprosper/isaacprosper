...
const Hero = () => {
  return (
    <section className='flex flex-wrap justify-center items-center pt-32 px-5 lg:pb-24 lg:pt-40 sm:pb-10 ssm:pb-10 space-y-10 lg:space-y-0 lg:space-x-10 text-white'>
